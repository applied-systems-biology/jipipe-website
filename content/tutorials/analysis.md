...
<div class=tutorial-list>
  ...
  <div class="tutorial-item">
    ...
    <div class="tutorial-item-content">
      ...
      We continue the analysis with a Gaussian filter that can be found in <code>Process &gt; Blur &gt; Gaussian blur 2D</code>.
  ...
  <div class="tutorial-item">
    ...
    <div class="tutorial-item-content">
      ...
      <ul>
        ...
        <li><code>Process &gt; Binary &gt; Distance transform watershed 2D</code></li>
        <li><code>Analyze &gt; Find particles 2D</code></li>
      </ul>
      <br/>
